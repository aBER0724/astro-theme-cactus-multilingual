...
const ui = {
	en: {
		...
		"projects.description": "Projects I maintain and the posts written about them.",
		"projects.repository": "Repository",
		"projects.techStack": "Tech stack",
		"projects.relatedPosts": "Related posts",
		"projects.pinned": "Pinned project",
		...
		"post.tagMore": "View more posts with the tag",
	...
	zh: {
		...
		"home.projects": "项目",
		"projects.title": "项目",
		"projects.description": "我维护的项目，以及相关文章。",
		"projects.repository": "仓库",
		"projects.techStack": "技术栈",
		"projects.relatedPosts": "相关文章",
		"projects.pinned": "置顶项目",
	...
	ja: {
		...
		"projects.description": "管理しているプロジェクトと、プロジェクト名のタグを付けた関連記事です。",
		"projects.repository": "リポジトリ",
		"projects.techStack": "技術スタック",
		"projects.relatedPosts": "関連記事",
		"projects.pinned": "固定プロジェクト",
